...
class BasketsControllerTest < ActionController::TestCase
  ...
  test "should create basket" do
    assert_difference('Basket.count') do
      post :create, basket: { address: @basket.address, integer: @basket.integer, status: @basket.status, text: @basket.text, type_of_delivery: @basket.type_of_delivery, user_id: @basket.user_id }
    end
  ...
  test "should update basket" do
    patch :update, id: @basket, basket: { address: @basket.address, integer: @basket.integer, status: @basket.status, text: @basket.text, type_of_delivery: @basket.type_of_delivery, user_id: @basket.user_id }
    assert_redirected_to basket_path(assigns(:basket))
  end
